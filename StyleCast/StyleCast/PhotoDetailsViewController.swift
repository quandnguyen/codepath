...
//  StyleCast
//
//  Created by Nguyen, Quan on 11/11/16.
...
class PhotoDetailsViewController: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        attributes = [locationView, tempView, timeStampView, likesView, weatherIconView, heartButton, closeButton, weatherConditionView]
